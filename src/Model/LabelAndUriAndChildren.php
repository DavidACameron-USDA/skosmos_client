...
/**
 * LabelAndUriAndChildren Class Doc Comment
 *
 * @category Class
 * @package  SkosmosClient
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LabelAndUriAndChildren implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LabelAndUriAndChildren';
     ...
     * Sets has_children
     *
     * @param bool $has_children Indicates whether the concept has children of its' own (narrower concepts)
     *
     * @return $this
     */
     ...
     * Sets label
     *
     * @param string $label Preferred label of concept
     *
     * @return $this
     */
