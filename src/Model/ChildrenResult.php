...
/**
 * ChildrenResult Class Doc Comment
 *
 * @category Class
 * @package  SkosmosClient
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ChildrenResult implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ChildrenResult';
    ...
    protected static $swaggerTypes = [
        'uri' => 'string',
        'narrower' => '\SkosmosClient\Model\PrefAndUriAndChildren[]'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['narrower'] === null) {
            $invalidProperties[] = "'narrower' can't be null";
        }
     ...
     * Gets narrower
     *
     * @return \SkosmosClient\Model\PrefAndUriAndChildren[]
     */
     ...
     * Sets narrower
     *
     * @param \SkosmosClient\Model\PrefAndUriAndChildren[] $narrower narrower
     *
     * @return $this
     */
