...
/**
 * HierarchyResult Class Doc Comment
 *
 * @category Class
 * @package  SkosmosClient
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class HierarchyResult implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'HierarchyResult';
    ...
    protected static $swaggerTypes = [
        'uri' => 'string',
        'broader' => 'string[]',
        'narrower' => '\SkosmosClient\Model\LabelAndUriAndChildren[]',
        'has_children' => 'bool',
        'pref_label' => 'string',
        'notation' => 'string',
        'top' => 'string'
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['narrower'] = isset($data['narrower']) ? $data['narrower'] : null;
     ...
     * Gets narrower
     *
     * @return \SkosmosClient\Model\LabelAndUriAndChildren[]
     */
    public function getNarrower()
    {
        return $this->container['narrower'];
    }

    /**
     * Sets narrower
     *
     * @param \SkosmosClient\Model\LabelAndUriAndChildren[] $narrower narrower
     *
     * @return $this
     */
    public function setNarrower($narrower)
    {
        $this->container['narrower'] = $narrower;
     ...
     * Sets has_children
     *
     * @param bool $has_children Indicates whether the concept has narrower concepts
     *
     * @return $this
     */
     ...
     * Sets top
     *
     * @param string $top This field is present if the current concept is a toplevel concept in the vocabulary and contains the concept scheme URI
     *
     * @return $this
     */
