...
/**
 * NarrowerTransitiveResult Class Doc Comment
 *
 * @category Class
 * @package  SkosmosClient
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class NarrowerTransitiveResult implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NarrowerTransitiveResult';
    ...
    protected static $swaggerTypes = [
        'uri' => 'string',
        'narrower_transitive' => '\SkosmosClient\Model\PrefAndUriAndNarrower[]'
    ];
    ...
    protected static $setters = [
        'uri' => 'setUri',
        'narrower_transitive' => 'setNarrowerTransitive'
    ];
    ...
    protected static $getters = [
        'uri' => 'getUri',
        'narrower_transitive' => 'getNarrowerTransitive'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['narrower_transitive'] = isset($data['narrower_transitive']) ? $data['narrower_transitive'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['narrower_transitive'] === null) {
            $invalidProperties[] = "'narrower_transitive' can't be null";
        }
    ...
    /**
     * Gets narrower_transitive
     *
     * @return \SkosmosClient\Model\PrefAndUriAndNarrower[]
     */
    public function getNarrowerTransitive()
    {
        return $this->container['narrower_transitive'];
    }

    /**
     * Sets narrower_transitive
     *
     * @param \SkosmosClient\Model\PrefAndUriAndNarrower[] $narrower_transitive narrower_transitive
     *
     * @return $this
     */
    public function setNarrowerTransitive($narrower_transitive)
    {
        $this->container['narrower_transitive'] = $narrower_transitive;
